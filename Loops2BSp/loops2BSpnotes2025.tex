...
\tpoint{Theorem}  {\em Recall that we given $d$, $U$, and $T_U: U \rightarrow U^\vee$ (invertible, signed).
...
\bpoint{Warning} In characteristic not equal to 2, condition (i) says
...
\bpoint{$j$ and $\alpha$ open condition}
write this down in terms of the language of the theorem.

\bpoint{Behavior under increase of  $d$}

\bpoint{Behavior under increase of $n$}
