...
We wil first prove a version of Theorem~\ref{thm: quiver description
...
V^{\stable}_{n,N,d}$ where $V^{\stable}_{n,N,d}$ is the locus of GIT
stable points for the action of $GL(A)$ on $V_{n,N,d}$. This will be
done in Section~\ref{sec: open conds and GIT}. 
...
\[
G(A,\phi ) = \{g\in GL(A)\quad :\quad g^{\vee}\phi g=\phi \}.
\]
...
the action of $G(A,\phi )$ on $V_{\mp ,n,d}$. This will be done in
Section~\ref{sec: open conds and GIT}. 



\section{Open conditions and GIT stability}\label{sec: open conds and GIT}
